...
clear
echo -e "${GREEN}==========================================${RESET}"
echo -e "${GREEN}Realm 面板 (磨砂清晰版)   ${RESET}"
echo -e "${GREEN}==========================================${RESET}"
...
echo -e ""
echo -e "${GREEN}==========================================${RESET}"
echo -e "${GREEN}✅ Realm 转发面板 (磨砂清晰版) 部署完成！${RESET}"
echo -e "${GREEN}==========================================${RESET}"
