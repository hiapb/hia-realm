...
clear
echo -e "${GREEN}==========================================${RESET}"
echo -e "${GREEN}Realm 面板 (圆角悬浮定制版)   ${RESET}"
echo -e "${GREEN}==========================================${RESET}"
...
fn default_bg_pc() -> String { "https://img.inim.im/file/1765446244982_1765446202693.jpg".to_string() }
...
echo -e ""
echo -e "${GREEN}==========================================${RESET}"
echo -e "${GREEN}✅ Realm 转发面板 (圆角悬浮定制版) 部署完成！${RESET}"
echo -e "${GREEN}==========================================${RESET}"
