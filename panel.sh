...
clear
echo -e "${GREEN}==========================================${RESET}"
echo -e "${GREEN}Realm 面板 (护眼圆角定制版)   ${RESET}"
echo -e "${GREEN}==========================================${RESET}"
