...
fn default_bg_mobile() -> String { "https://img.inim.im/file/1764296937373_bg_m_2.png?q=80&w=1000&auto=format&fit=crop".to_string() }
...
echo -e ""
echo -e "${GREEN}==========================================${RESET}"
echo -e "${GREEN}✅ Realm 转发面板自部署完成！${RESET}"
echo -e "${GREEN}==========================================${RESET}"
