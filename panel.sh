...
clear
echo -e "${GREEN}==========================================${RESET}"
echo -e "${GREEN}Realm 面板 (移动端UI精修版)   ${RESET}"
echo -e "${GREEN}==========================================${RESET}"
